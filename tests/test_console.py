...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_create(self):
        h = ("Create a new instance of BaseModel.\n        "
             "Exceptions:\n            "
             "SyntaxError: when there is no args given\n            "
             "NameError: No object with that name")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "Quits command to exit the program at end of file"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_show(self):
        h = ("Prints string representation of an instance\n        "
             "Exceptions:\n            "
             "SyntaxError: when there is no args given\n            "
    ...
    def test_help_all(self):
        h = ("Print all string representation of all instances\n        "
             "Exceptions:\n            "
             "NameError:No object with that name")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        h = ("counts number of instances of a class")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help count"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_update(self):
        h = ("Updates the instance by adding or updating attribute\n        "
             "Exceptions:\n            "
             "SyntaxError: when there is no args given\n            "
             "NAMEERROR:No object of that name\n"
             "IndexError: when there no id given\n            "
             "KeyError: when there is no valid id given\n            "
             "AttributeError: when no attribute given\n            "
             "ValueError: when there no value given")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help(self):
        h = ("Documented commands (type help <topic>):\n"
             "========================================\n"
             "EOF  all  counts,  create,  destroy,  help  quit  show  update")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(obj._str_(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_id_dot_notation(self):
        correct = "* instance id is missing *"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_valid_string_attr_space_notation(self):
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["BaseModel.{}".format(testId)]._dict_
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["User.{}".format(testId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["City.{}".format(testId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Place.{}".format(testId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Amenity.{}".format(testId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Review.{}".format(testId)]._dict_
    ...
    def test_update_valid_string_attr_dot_notation(self):
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["BaseModel.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["User.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["State.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["City.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Place.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Amenity.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["Review.{}".format(tId)]._dict_
        self.assertEqual("attr_value", test_dict["attr_name"])
...
class TestHBNBCommand_count(unittest.TestCase):
    """Unittests - testing count method of HBNB command interpreter."""
